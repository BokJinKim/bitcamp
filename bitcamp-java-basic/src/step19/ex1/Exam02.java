...
public class Exam02 {
    ...
    public static void main(String[] args) {
        // 1) 패키지 경로 준비
        File packageDir = new File("C:\\Users\\Bit\\git\\bitcamp\\bitcamp-java-basic\\bin\\step19\\ex1");
    ...
    static List<File> findFiles(File dir) {
        // 배열을 사용하는 것 보다 LinkedList를 사용하는 것이 편하기 때문에
        // 배열에 들어있는 File 객체들을 LinkedList로 복사한다.
