...
public class Exam02_5 {
    public static void main(String[] args) throws Exception {
        ...
        // 달력은 그레고리안 달력을 사용한다.
        Calendar c = Calendar.getInstance(); //(Singleton 패턴내용)
        
        // 인스턴스 메서드 활용
        System.out.println(c.get(1)); // 년도                        get은 인스턴스 정보 조회
        System.out.println(c.get(2) + 1); // 월 (0 ~ 11)
        System.out.println(c.get(5)); // 일
        System.out.println(c.get(7)); // 요일 (1 ~ 7) 일 ~ 토
        ...
        // 상수의 활용
        System.out.println(c.get(Calendar.YEAR)); // 년도                        get은 인스턴스 정보 조회
        System.out.println(c.get(Calendar.MONTH) + 1); // 월 (0 ~ 11)
        System.out.println(c.get(Calendar.DATE)); // 일
        System.out.println(c.get(Calendar.DAY_OF_WEEK)); // 요일 (1 ~ 7) 일 ~ 토
