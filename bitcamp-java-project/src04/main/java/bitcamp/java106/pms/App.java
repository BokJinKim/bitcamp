...
// ver 1.2 - 명령어를 잘못 입력 했을 때 안내 문구를 출력한다.
...
// ver 0.3 - 사용자로부터 입력 받는 것을 무한 반복 한다.
...
public class App {
    public static void main(String[] args) {
        ...
        Team[] teams = new Team[1000]; // 팀 객체의 주소를 1000개 받는 것이다. (레퍼런스)
        int teamIndex = 0; // 주소를 채울 방의 이름
        ...
        while (true) {
            ...
            if (menu.equals("quit")) {
                ...
                teams[teamIndex++] = team; // 방 번호 하나씩 증가
                ...
                members[memberIndex++] = member; // 방 번호 하나씩 증가
                ...
                if (member == null) {
                    System.out.println("해당 이름의 id가 없습니다.");
                } else {
